      ...
      <React.Fragment>
        <header className="bg-gray-900">
          <div className="flex justify-between px-4 py-3">
            ...
            <div className="flex">
              <button onClick={this.handleToggle} className="nav-btn px-2 text-gray-500 hover:text-white focus:outline-none focus:text-white">
                { this.state.isOpen ?
        ...
        {/* 51min */}
          <ul className={this.state.isOpen ? "nav-links show-nav" : "nav-links"}>
            <div className="px-2 pt-2 pb-5 border-b border-gray-800">
              ...
              <Link to='/courses' className="mt-2 font-semibold rounded leading-tight text-white px-3 py-1 block hover:bg-gray-800">Courses</Link>
            </div>
           {/* <div className="px-5 py-5">
              ...
              <div className="mt-5">
                <Link to="/courses" className="block text-gray-400 hover:text-white">Account</Link>
